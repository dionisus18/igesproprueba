    ...
    <?php if ($fila['tipoTarea'] == 0) : ?>
            ...
            <tr class="filaNormal">
                ...
                <?php
                    ...
                    <td class="clickable-row btn Tcol" data-href="../controller/ingresoTareas.php?idTarea=<?php echo $fila['_id'] ?>" style="vertical-align:middle; text-align:center;">
